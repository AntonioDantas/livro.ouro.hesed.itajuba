...
--------------------------*/
  ...
  youtube=function(id_,w_,h_) {
	...
	$('body').prepend('<div id="v5_lightbox"><div class="bcg"></div><iframe class="youtube-player youtube_lightbox" width='+w+' height='+h+' src="https://www.youtube.com/embed/'+id+'?html5=1" frameborder="0" allowfullscreen></iframe></div>');
...
var Book_v5 = {
	...
	book_position: function() {
		...
		var y = this.autoMarginT() + this.toolsHeight - 40; //$('#fb5').height()/2-half_height;
		$('#fb5-container-book').css({ left: x, top:y });
